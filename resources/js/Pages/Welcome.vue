...
<template>
    ...
    <div class="bg-green-50 h-screen">
        <div class="flex flex-col items-center justify-center text-center ">
            <div class="">
                <DotLottieVue style="height: 300px; width: 300px" autoplay loop src="/images/car_animation.lottie"/>
            </div>

            <h1 class="text-7xl font-bold text-green-700 mb-4">EHEE</h1>
            <p class="text-lg text-gray-600 mb-4">System for querying vehicle registry information from MTA for the
